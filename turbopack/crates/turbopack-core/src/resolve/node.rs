...
pub fn node_cjs_resolve_options(root: ResolvedFileSystemPath) -> Vc<ResolveOptions> {
...
#[turbo_tasks::function]
pub fn node_esm_resolve_options(root: ResolvedFileSystemPath) -> Vc<ResolveOptions> {
    let conditions: ResolutionConditions = [
        ("node".into(), ConditionValue::Set),
